...
<link rel="icon" type="image/png" sizes="16x16"
	href="${pageContext.request.contextPath}/image/logo/mauicon.png">
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="theme-color" content="#ffffff">
<meta name='viewport' content='width=device-width, initial-scale=1'>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/mau.css">
<link
			...
			<div class="uk-modal-header">
				...
				<div>
					...
					<input type="checkbox" id="myCheck" name="myCheck"
						style="display: none;" <%if(chk!=null){ %> checked <%}%>>
					<label for="myCheck"></label>
					<%if(user!=null) {%>
					<form method="get" id="placeFavorite">
						<input type="hidden" name="placeSeq"
							value="<%=place.getPlaceSeq()%>"> <input type="hidden"
							name="userSeqId" value="<%=user.getUserSeqId()%>">
					</form>
					<%} %>
				</div>
				<script>
			...
			<div class="uk-modal-body" uk-overflow-auto>
				...
				<div class="img-box">
					<div class="img_upload_box" style="width: 950px">
						...
						<%if(photo==null){ %>
						<div class="size">
							장소와 관련된 사진을 올려주시면 <br> 페이지가 더 유익해질 것 같아요!
							<form
								action="${pageContext.request.contextPath}/uploadImg/<%=place.getPlaceSeq()%>"
								method="post" enctype="multipart/form-data">
								<input type="file" name="photoUpload" /> <input type="submit"
									value="업로드" style="width: 200px;">
							</form>
							<br>
						</div>
						<%} else {%>
							...
							<form
								...
								<div id="img_input">
									<input type="file" name="photoUpload"
										style="position: relative; left: 40px; padding-top: 20px; padding-bottom: 10px" />
						...
						<div class="img_upload_box">
							<img src="/mau/imgPath/<%=photo.get(i).getPhotoName()%>"
				...
				<div class="row">
					<div class="col-md-6" style="height: 650px;">
						<div class="info-box">
							...
							<!-- 장소 키워드카드 -->
							<div class="inline-theme-cards clear"
								onclick="trackOutboundLink('place_page','inbound','go-to-theme');">
						...
						<div class="info-box">
							...
							<a id="static_map">
								<div id="info-map" class="map-box border-radius shadow">
									...
									<input type="hidden" name="SouthWest"
										value="<%=place.getPlaceSouthWest() %>"> <input
										type="hidden" name="NorthEast"
										value="<%=place.getPlaceNorthEast() %>">
									<!-- <p><em>마커를 클릭해주세요!</em></p>  -->
									<script
										src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
									<script type="text/javascript"
										src="//dapi.kakao.com/v2/maps/sdk.js?appkey=51c537c4b3603a65b8ba8a854278340e"></script>
									<script>
						...
						<div class="info-box" style="position: relative; bottom: 80px;">
							...
							<div class="share-box">
								<div class="share-btn shadow link" onclick="copy_url()"
									style="margin-right: 10px; border-radius: 50%; width: 30px; height: 30px;">
									<img
										src="${pageContext.request.contextPath}/resources/images/icon-share.png"
										style="position: relative; right: 20px; bottom: 20px;">
									<input type="hidden" name="url" id="SharePlaceUrl"
										value="http://localhost:8181/mau/detailInfo/<%=place.getPlaceSeq() %>">
								</div>
								<!-- <input type="text" id="SharePlaceUrl"> -->
								<a href="javascript:kakao();" id="kakao-link-btn">
									<div class="share-btn shadow kakao">
										<img id="kakao_url"
											src="${pageContext.request.contextPath}/resources/images/icon-kakao.png"
											href="'http://localhost:8181/mau/detailInfo/'+<%=place.getPlaceSeq()%>">
									</div>
								</a> <a class="share-place-btn" class="fb-share-button"
									target="_blank" href="https://http://localhost:8181/mau/index">
									<div class="share-btn shadow facebook">
										<img id="kakao_url"
											src="${pageContext.request.contextPath}/resources/images/icon-facebook.png">
									</div>
								</a>
							</div>
						</div>
					...
					<div class="col-md-6">
						<div id="comment-box" class="info-box">
							...
							<div onclick="get_more_place_comment()"
								class="load-more button shadow bg-white padding-15"
								style="width: 245%;">
								<!-- <span>더 불러오기</span> -->
								<table>
                            ...
                            if(user.getUserSeqId()==review.get(i).getUserSeqId()){%>
									<tr>
										<td><img class="img"
											src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/285/<%=review.get(i).getPlaceState() %>"
											width="30px"></td>
										<td><%=review.get(i).getReview() %></td>
										<td>
											<form
												action="${pageContext.request.contextPath}/reviewDelete"
												method="post" name="frm">
												<input type="hidden" name="placeSeq"
													value="<%=place.getPlaceSeq()%>"> <input
													type="hidden" name="reviewSeq"
													value="<%=review.get(i).getReviewSeq()%>"> <input
													type="submit" id="delete_review_btn" value="    "
						...
						<div class="info-box">
							...
							<div class="comment-cards" style="font-size: 17px; width: 80%">
								아래 이모지를 눌러서 의견을 남겨보세요!</div>
							<div class="emoji-list">
								<div class="uk-width-1-5">
									<div id="emoji_1"
										class="emoji-box bg-white border-radius shadow"
										data-icon="1-a" data-score="1">
										<input id="radio_1" type="radio" name="emoji" class="emoji"
											value="disappointed-face_1f61e.png" style="display: none">
										<label for="radio_1" style="cursor: pointer;"><img
											id="img1"
								...
								<div class="uk-width-1-5">
									<div id="emoji_2"
										...
										<input id="radio_2" type="radio" name="emoji" class="emoji"
											value="expressionless-face_1f611.png" style="display: none">
										<label for="radio_2" style="cursor: pointer;"><img
											id="img2"
								...
								<div class="uk-width-1-5">
									<div id="emoji_3"
										...
										<input id="radio_3" type="radio" name="emoji" class="emoji"
								...
								<div class="uk-width-1-5">
									<div id="emoji_4"
										...
										<input id="radio_4" type="radio" name="emoji" class="emoji"
											value="partying-face_1f973.png" style="display: none;">
										<label for="radio_4" style="cursor: pointer;"><img
											id="img4"
								...
								<div class="uk-width-1-5">
									<div id="emoji_5"
										...
										<input id="radio_5" type="radio" name="emoji" class="emoji"
											value="face-with-steam-from-nose_1f624.png"
								...
								<div class="uk-width-1-6">
									<div id="emoji_6"
										...
										<input id="radio_6" type="radio" name="emoji" class="emoji"
											value="pleading-face_1f97a.png" style="display: none">
										<label for="radio_6" style="cursor: pointer;"><img
											id="img6"
								...
								<div class="uk-width-1-6">
									<div id="emoji_7"
										...
										<input id="radio_7" type="radio" name="emoji" class="emoji"
											value="zipper-mouth-face_1f910.png" style="display: none">
										<label for="radio_7" style="cursor: pointer;"><img
											id="img7"
								...
								<div class="uk-width-1-6">
									<div id="emoji_8"
										...
										<input id="radio_8" type="radio" name="emoji" class="emoji"
											value="face-with-rolling-eyes_1f644.png"
								...
								<div class="uk-width-1-6">
									<div id="emoji_9"
										...
										<input id="radio_9" type="radio" name="emoji" class="emoji"
								...
								<div class="uk-width-1-6">
									<div id="emoji_10"
										...
										<input id="radio_10" type="radio" name="emoji" class="emoji"
						...
						<div id="inputbox" style="display: none;">
							<form action="${pageContext.request.contextPath}/review"
								method="post" name="frm">
								<textarea id="review" class="shadow bg-white" name="review"
									rows="4" cols="50" placeholder="여기에 의견을 입력해주세요."
									style="margin-top: 30px"></textarea>
								<input type="hidden" id="placeSeq" name="placeSeq"
									value="<%=place.getPlaceSeq()%>"> <input type="hidden"
									id="userSeqId" name="userSeqId" <%if(user!=null){%>
									value="<%=user.getUserSeqId()%><%}%>"> <input
									type="hidden" id="placeState" name="placeState" value="">
								<div
									class="submit-button disabled button shadow bg-white padding-15"
									style="width: 450px;">
									<input type="submit" value="저장하기"
										style="width: 380px; border-style: none; background-color: white;">
								</div>
							</form>
						</div>
		...
		<a id="modal_place_info_url" class="go-kakao-btn">
			<div class="d-grid gap-2">
				<button class="btn btn-primary" type="button"
					onclick="location.href='https://place.map.kakao.com/<%=place.getPlaceId()%>'">카카오맵으로
					자세히 보기</button>
			</div>
		</a>
	</div>
